	...
	<nav class="navbar navbar-default navbar-fixed-top navbar-sticky" id="expnav" style="margin-top:64px;">
		<div class="row">
			...
			<div class="col-sm-6">
				<div class="row">
					<div class="col-sm-3">
						<a href="explore.php?user_id=<?php echo $_SESSION['uid']; ?>" id="newsfeed" class="expnavlinks newsfeed" style="color:#626663;font-size:;"><i class="fa fa-newspaper-o" aria-hidden="true" style="color:#626663;font-size:1.25em;"></i> News Feed</a>
					</div>
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
						<a href="expevents.php?user_id=<?php echo $_SESSION['uid']; ?>" id="events" class="expnavlinks events" style="color:black;"><i class="fa fa-calendar" aria-hidden="true" style="color:black;font-size:1.2em;"></i> Events</a>
					</div>
				</div>
			</div>
			<div class="col-sm-3">
