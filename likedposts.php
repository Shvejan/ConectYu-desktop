...
include("header.php");
include("functions/likepstsoperations.php");
?>
<?php
	$u_id=$_SESSION['uid'];
...
<html lang="en">
<head>
	<title>ConectYu - Liked Posts</title>
	<meta charset="utf-8">
	...
	<div class="row" style="margin-top:50px;">
		...
		<div class="col-sm-5" style="background-color:white;">
			<div class="row" id="savedposts" style="border:1px solid #e6e6e6;padding:10px;">
				<div class="col-sm-12">
					<span><a id="unlikeallposts" class="btn btn-default" style="float:right;margin-top:2.5%;margin-right:3%;">unlike all posts</a></span>
					...
					<h3 style="font-family: 'Merienda One', cursive;margin-left:10%;">liked Posts </h3>
					<hr>
					<div class='row likedposts'></div>
				</div>
			</div>
		</div>
		<div class="col-sm-4">
...
<script>
	...
	function likedPosts(){
		...
		$.ajax({
			url:'functions/likepstsoperations.php',
			data:'likedpost=1'+'&user_id='+user_id,
			type:'post',
	...
	$('#unlikeallposts').click(function(){
		var user_id=<?php echo json_encode($_SESSION['uid']); ?>;
		$.ajax({
			url:'functions/likepstsoperations.php',
			data:'unlikeallposts=1'+'&user_id='+user_id,
			type:'post',
			success:function(res){
				//alert(rest);
				$('.likedposts').html(res);
